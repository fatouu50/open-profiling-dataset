...
`USA-007-DAHMER` · record status: **in_progress** · schema 0.1.0

> **This file is generated.** It is rendered from [`USA-007-DAHMER.json`](./USA-007-DAHMER.json) by `scripts/render_md.py`. Do not edit it by hand — edits are overwritten, and a hand-written report can assert what the data does not support. Change the JSON, then re-render.
...
> No documented aliases. He did give a false name for a victim to police in May 1991 — see investigation.detection_delay_factors.
...
Deceased. Convicted of 15 counts of murder in Wisconsin and, separately, of one further murder in Ohio.
...
> No agency-published attribution beyond the convictions has been retrieved.
...
> No self-reported total distinct from the charged offences has been retrieved.

**Estimate provenance** — *reported*

The count derives entirely from the two conviction records. No higher figure with traceable provenance exists for this subject.

Sources: [2]

> Unusual in this dataset: the popular figure and the conviction figure coincide. There is no inflated number circulating for Dahmer, which makes his record cleaner on this axis than Bundy, Hall or Ridgway.
...
> Arrest followed in July 1991 when a victim escaped and brought police to the apartment.
...
> Accounts of childhood interest in animal remains are ubiquitous in secondary literature and were advanced at the insanity trial. No contemporaneous documentation has been retrieved and none is entered.
...
> Psychiatric evidence was presented and tested at the insanity phase, but the retrieved sources do not itemise the competing diagnoses. This field is therefore null despite being populatable in principle — the second such case after USA-005-GACY, where the equivalent evidence WAS itemised in the appellate opinion. A contributor retrieving the Milwaukee County trial record should populate this; it is one of only two subjects in the dataset where adversarially tested clinical evidence exists.

**Competency findings** — *reported*

The insanity plea was rejected. The jury found him legally sane at the time of the offences.

Sources: [2]

> A finding of legal responsibility is a legal conclusion, not a clinical one, and does not establish the absence of mental disorder. The same caution applies here as in USA-005-GACY.

**Psychometric results** — ○ *not established*

—

> No instrument, administrator or date retrieved.
...
> Not catalogued. This subject carries an unusually heavy load of retrospective diagnostic commentary, much of it generated by dramatisations rather than clinicians.

---

## Offence behaviour

**Victim selection** — **established**
...
> No scene documentation retrieved. Note that this is the subject for whom popular accounts assert the most elaborate post-mortem conduct in the entire dataset, and the field is null. Detail of that kind is also constrained by ETHICS.md independently of sourcing: it serves appetite rather than analysis.

**Post offence behaviour** — ○ *not established*

—

> Not entered. See the note on signature_behaviour: this is a case where the ethical constraint and the sourcing constraint point the same way.

**Forensic countermeasures** — ○ *not established*

—

> Not established. He retained remains in his residence, which is not on its face evasive conduct — the same observation as USA-005-GACY.
...
In July 1991 a victim escaped the apartment and brought police to it. Human remains were recovered from the premises.
...
> No interrogation record retrieved.

**Confession reliability** — *reported*

Not load-bearing for the convictions, which rested on remains recovered from his residence. He admitted the offences and contested only his mental state.

Sources: [2]

> Structurally unusual: the plea conceded the acts and litigated only responsibility. Nothing in the victim count depends on his account, but a great deal of the circulating narrative detail does.

**Trial outcome** — *reported*

Tried in Milwaukee County on the question of legal responsibility. The jury found him sane and guilty on 15 February 1992.

Sources: [2]

> The second insanity defence tried and rejected in this dataset, after USA-005-GACY. Both juries rejected it. That is a datum about the reception of psychiatric evidence, not about its merit.
...
- Whether the dismissal and subsequent reinstatement with back pay of the officers involved in the May 1991 events was an appropriate outcome — the federal civil rights claim was dismissed and the city settled.
- Whether legal sanity findings in this case and in USA-005-GACY reflect the evidence or the difficulty juries have accepting an insanity defence in cases of this severity.

### Material deliberately excluded

- Press epithets for this subject, which foreground post-mortem conduct in a form that serves appetite rather than analysis.
- Detail of post-mortem conduct generally, excluded under ETHICS.md — this is the record where that constraint bites hardest, and where popular accounts consist of little else.
- The name of the surviving victim of the 1988 offence, a living third party.
- Childhood aetiologies advanced at the insanity trial and repeated as established causation.
- Material originating in television dramatisations, of which this case has generated several.
